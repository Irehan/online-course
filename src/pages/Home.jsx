                            ...
                            <div className="card">
                                <div className="card-header p-0 position-relative">
                                    ...
                                    <div className="post-pos">
                                        <Link to="#reciepe" className="receipe blue">
                                            Beginner
                                        </Link>
                                    </div>
                                </div>
                                <div className="card-body course-details">
                                    ...
                                    <Link to="#course-single" className="course-desc">
                                    ...
                                    <div className="author align-items-center">
                                        ...
                                        <ul className="blog-meta">
                                            <li>
                                                ...
                                                <Link to="#author"> Olivia</Link>
                                            </li>
                                            <li>
                                                <span className="meta-value mx-1">in</span>{" "}
                                                <Link to="#author"> Programing</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="card-footer">
                                    <div className="author align-items-center">
                                        ...
                                        <ul className="blog-meta">
                                            <li>
                                                <span className="meta-value mx-1">by</span>{" "}
                                                <Link to="#author"> Isabella</Link>
                                            </li>
                                            <li>
                                                <span className="meta-value mx-1">in</span>{" "}
                                                <Link to="#author"> Teaching</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
